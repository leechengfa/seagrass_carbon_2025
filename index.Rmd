...
The uncertainty in the prediction of the seagrass extent is calculated by first taking the image-level median of the per pixel seagrass class probability, then inverting it by subtracting 1 with it, and finally multiplying together with the global model accuracy and the predicted seagrass extent [@davies2026].

\begin{equation}
\tau = A \times G_{a} \times (1 - \overline{\sum p}) (\#eq:tauuncertainty)
\end{equation}

This section will continue to be updated as the work progresses.
